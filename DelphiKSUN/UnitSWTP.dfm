object FormSWTP: TFormSWTP
  ...
  object wwRecordViewDialog1: TwwRecordViewDialog
    ...
    Caption = 'Record View'
    Selected.Strings = (
      'Code'#9'6'#9#1050#1086#1076#9'F'
      'Name'#9'50'#9#1053#1072#1080#1084#1077#1085#1086#1074#1072#1085#1080#1077#9'F'
      'Mfo'#9'13'#9#1052#1060#1054#9'F'
      'Okpo'#9'13'#9#1054#1050#1055#1054#9'F'
      'Rs'#9'13'#9#1056#1072#1089#1095#1077#1090#1085#1099#1081' '#1089#1095#1077#1090#9'F'
      'Unn'#9'13'#9#1059#1053#1053#9'F'
      'Bank'#9'50'#9#1041#1072#1085#1082#9'F'
      'Adres'#9'50'#9#1040#1076#1088#1077#1089#9'F'
      'Lic'#9'50'#9#1051#1080#1094#1077#1085#1079#1080#1103#9'F')
    NavigatorFlat = True
    Left = 392
    Top = 440
  end
