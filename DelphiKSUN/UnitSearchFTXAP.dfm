object FormSearchFTXAP: TFormSearchFTXAP
  Left = 319
  Top = 168
  Width = 591
  Height = 381
  ...
  object AP: TwwQuery
    ...
    SQL.Strings = (
      'Select ID,Num,Data,'
      ' SumA,SumB,Diff as dif'
      
        'from KSU.FTXAP where (Podr=:podr)and(God=:god)and(Mes=:mes)and(B' +
        'S=:bs)'
      'and(MOL=:mol)'
      'and Pr=0'
      'Order by Num')
    ...
    object APNum: TIntegerField
      DisplayLabel = #1053#1086#1084#1077#1088
      DisplayWidth = 10
      FieldName = 'Num'
      Origin = 'BKSU."KSU.FTXAP".Num'
    end
    object APData: TDateField
      DisplayLabel = #1044#1072#1090#1072
      DisplayWidth = 10
      FieldName = 'Data'
      Origin = 'BKSU."KSU.FTXAP".Data'
    end
    object APSumA: TFloatField
    ...
    object APdif: TFloatField
      DisplayLabel = #1056#1072#1079#1085#1080#1094#1072' '#1074' '#1087#1077#1088#1077#1086#1094#1077#1085#1082#1077
      DisplayWidth = 10
      FieldName = 'dif'
      Origin = 'BKSU."KSU.FTXAP".Diff'
    end
    object APID: TIntegerField
      FieldName = 'ID'
