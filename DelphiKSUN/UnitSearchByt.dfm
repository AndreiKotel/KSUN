object FormSearchByt: TFormSearchByt
  Left = 204
  Top = 211
  Width = 440
  Height = 448
  Caption = #1055#1086#1080#1089#1082' '#1076#1083#1103' '#1089#1090#1077#1082#1083#1086#1087#1086#1089#1091#1076#1099
  Color = clBtnFace
  ...
  object wwQuery1: TwwQuery
    ...
    SQL.Strings = (
        ...
        'Select Nnt,Name,Price from KSU.STMC  where (SK=:sk) and (KodGr=9' +
        '3)')
